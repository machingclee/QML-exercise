...
ApplicationWindow {
    ...
    Action{
        ...
        icon.source: "qrc:/flats/outlines/oNew.png"
        onTriggered: {
            editor.clear()
        }
    }
    ...
    Action{
        ...
        text: qsTr("Open")
        icon.color: "transparent"
        icon.source: "qrc:/flats/outlines/oOpen.png"
    ...
    Action{
        ...
        text: qsTr("Save")
        icon.color: "transparent"
        icon.source: "qrc:/flats/outlines/oSave.png"
    ...
    Action{
        ...
        text: qsTr("Copy")
        icon.color: "transparent"
        icon.source: "qrc:/flats/outlines/oCopy.png"
    ...
    Action{
        ...
        text: qsTr("Cut")
        icon.color: "transparent"
        icon.source: "qrc:/flats/outlines/oCut.png"
    ...
    Action{
        ...
        text: qsTr("Paste")
        icon.color: "transparent"
        icon.source: "qrc:/flats/outlines/oPaste.png"
